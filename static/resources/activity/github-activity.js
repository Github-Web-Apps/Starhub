...
/*! GitHub Activity Stream - v0.1.5 * Copyright (c) 2019 Intika * MIT License */
    ...
    getMessageFor: function(data) {
      ...
      if (p.commits) {
        ...
        if (length === 2) {
          ...
          data.commitsMessage = Mustache.render('<a href="https://github.com/{{repo}}/compare/{{shaDiff}}">{{length}} more ' + pluralize('commit', length - 2) + 
