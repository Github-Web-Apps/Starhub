...
function start() {
    appendToWidget("body", "style", "", "@import url(https://fonts.googleapis.com/css?family=Noto+Sans:400,700);.gh-widget-link,.gh-widget-link:hover{text-decoration:none}.gh-widget-container{display:flex;flex-direction:row;flex-wrap:no-wrap;align-items:center;justify-content:center;color:#333;font-family:'Noto Sans',sans-serif}.gh-widget-personal-details .bio{color:#222222l;} .gh-widget-stats .count{color:#4078C0}.github-widget{border:1px solid #DDD;}.gh-widget-item{flex:1;text-align:center;padding:10px}.gh-widget-repositories .language{text-align:left}.gh-widget-repositories .language div,.gh-widget-repositories .stars div{padding:5px 0}.gh-widget-photo{flex:2; padding:0px;}.gh-widget-photo img{border-radius:100%;}.gh-widget-personal-details{flex:6;padding:0px;}.gh-widget-personal-details .full-name{font-size:1.5em;line-height:1.5em}.gh-widget-personal-details .location{font-size:.8em}.gh-widget-stats .count{font-size:1.2em;font-weight:700}.gh-widget-repositories .names{flex:2;text-align:left}.gh-widget-repositories .names div{padding:5px 0;text-overflow:ellipsis}.gh-widget-follow{flex:2}.gh-widget-active-time{flex:4;font-size:.8em}.gh-widget-heading{font-weight:400;color:#666}.gh-widget-hr{border:1px solid #DDD}.gh-widget-link{color:#4078C0}.gh-widget-follow button{width:100%;height:2em;border:none;background:#ddd} img{ vertical-align:middle;} .github-box-title{position:relative;border-bottom:1px solid #DDD;border-radius:3px 3px 0 0;background:#FCFCFC;background:-moz-linear-gradient(#FCFCFC,#EBEBEB);background:-webkit-linear-gradient(#FCFCFC,#EBEBEB);}");
    for (var a = document.querySelectorAll(".github-widget"), b = 0; b < a.length; b++) {
        var c = a[b];
        c.setAttribute("id", "widget" + b);
        appendToWidget("#widget" + b, "div", "", '<div class="gh-widget-container"><div class="gh-widget-item gh-widget-photo"></div></div><div class="gh-widget-container"><div class="gh-widget-item gh-widget-personal-details"></div></div><div class="gh-widget-container gh-widget-stats"></div><hr class="gh-widget-hr"><div class="gh-widget-container"><div class="gh-widget-item gh-widget-heading">Popular Repositories</div></div><div class="gh-widget-repositories"></div><div class="gh-widget-container"><div class="gh-widget-item gh-widget-active-time" style="margin:auto;"></div></div>');
...
function updateLastPush(a, b) {
    appendToWidget(b + " .gh-widget-active-time", "span", "", "Last active on main default organization: " + (a ? a + " day(s) ago": "Today"))
}
...
function updateUserDetails(a, b) {
    appendToWidget(b + " .gh-widget-personal-details", "div", "full-name", '<a class="gh-widget-link" target="new" href="' + a.html_url + '">'+a.login+'</a></br>\
    			   <p style="font-size:15px;">ID: '+a.id+'</p>');
    a.bio && appendToWidget(b + " .gh-widget-personal-details", "div", "bio", a.bio);
    a.location && appendToWidget(b + " .gh-widget-personal-details", "div", "location", '<img src="static/resources/widgets/ic_location_on_black_48dp.png" width=20 height=20 />'+a.location);
	a.email && appendToWidget(b + " .gh-widget-personal-details", "div", "email", '<i class="mail icon"></i>'+a.email);
    ...
    appendToWidget(b + " .gh-widget-photo", "span", "", '<img style="width:120px;height:120px;" src="' + a.avatar_url + '">');
}
